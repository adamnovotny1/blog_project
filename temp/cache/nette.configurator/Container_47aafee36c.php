<?php
// source: /home/ejdy/blog_project/config/common.neon
// source: /home/ejdy/blog_project/config/services.neon
// source: /home/ejdy/blog_project/config/local.neon
// source: array
...
class Container_47aafee36c extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'App\Presenters\HomePresenter' => [2 => ['application.4']],
	...
	public function createService03(): App\Model\PostFacade
	{
	...
	{
		$service = new App\Presenters\EditPresenter($this->getService('03'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__4(): App\Presenters\HomePresenter
	{
		$service = new App\Presenters\HomePresenter($this->getService('03'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	{
		$service = new App\Presenters\PostPresenter($this->getService('03'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'/home/ejdy/blog_project/temp/cache/nette.application/touch',
		));
	...
	{
		return new Nette\Caching\Storages\FileStorage('/home/ejdy/blog_project/temp/cache');
	}
	...
	public function createServiceDatabase__default__connection(): Nette\Database\Connection
	{
		$service = new Nette\Database\Connection(
			'mysql:host=127.0.0.1;dbname=blog_system',
			/*sensitive{*/'root'/*}*/,
			/*sensitive{*/'root'/*}*/,
			[],
		);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_47aafee36c $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('/home/ejdy/blog_project/temp/cache/latte');
